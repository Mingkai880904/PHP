<?php
 ...
 $result = mysqli_query($conn,
                        "SELECT dept_detail.dept_name, ksu_std_name, ksu_std_grade
						 FROM ksu_std_table
						 LEFT JOIN dept_detail
						 ON ksu_std_table.ksu_std_department = dept_detail.dept_id
						 ORDER BY dept_name");
 echo "<table border='1'>
 <tr>
   <th>系別</th>  <th>學生姓名</th>  <th>學生成績</th>  <th>備註</th>
 </tr>";
...
?> 
<form enctype="multipart/form-data"  method="post" action="hw2.html">
