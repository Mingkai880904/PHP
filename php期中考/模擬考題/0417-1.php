...
echo "<table border='1'>
<tr>
    <th>學生姓名</th>  <th>姓名字串長度</th> <th>學生成績</th>   <th>備註</th>
</tr>";
...
{     
    ...
    echo "<td>" . str_word_count($row['ksu_std_name']). "</td>";      
    echo "<td>" . $row['ksu_std_grade'] . "</td>";
    
    if($row['ksu_std_grade'] < 60)
    { echo "<td style=\"background-color:yellow\">" . "補考" . "</td>";
    }
    else if($row['ksu_std_grade'] >= 60)
    { echo "<td style=\"background-color:lightgreen\">" . "免修" . "</td>";
    }
	else
    { echo "<td>" . "" . "</td>";
    }     
...
?> 
<form enctype="multipart/form-data"   method="post" action="0416-1.html">
