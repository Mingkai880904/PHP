<?php
 ...
 {   
   ...
   echo "<td>" . strrev($row['ksu_std_name']) . "</td>";
   if($row['ksu_std_grade'] < 60)
    { echo "<td style=\"background-color:lightblue\">" . "重修" . "</td>";
    }
	else
...
?> 
<form enctype="multipart/form-data"  method="post" action="0426-2.html">
